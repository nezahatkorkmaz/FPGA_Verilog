...
HD_PWD='C:/Users/LENOVO/Desktop/xorKapisi/xorKapisi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xorgate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xorgate.tcl
